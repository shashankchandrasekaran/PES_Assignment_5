 ...
 * Changes made: The structure was updated to delete length_low, length high and
 * create just one length
 */
...
#include <stdint.h>
#include <stdlib.h>
#include <string.h> //SC: Added this header file for using memcpy and memset
...
typedef struct 
{
	...
	uint32_t Length;       //SC: Created one length instead of 2
