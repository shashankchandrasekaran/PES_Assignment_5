 ...
 * Changes made: For the function hexdigit_to_int(char c), added a return 0
 * to avoid warning in release mode
 */
...
static unsigned char hexdigit_to_int(char c)
{
	...
	return 0;  //SC: Added return as this was giving warning
}
